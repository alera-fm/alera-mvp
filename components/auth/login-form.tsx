    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <Card className="border-0 shadow-xl bg-white dark:bg-[#0f0f1a]">
        <CardHeader className="text-center pb-6">
          <CardTitle className="text-2xl font-bold text-[#333] dark:text-white">Welcome Back</CardTitle>
          <CardDescription className="text-[#666] dark:text-gray-400">Sign in to your ALERA account</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center pt-4">
              <p className="text-[#666] dark:text-gray-400">
                ...
                <Link href="/auth/register" className="text-[#5d2c91] dark:text-purple-400 font-medium hover:underline">
                  Create one
                </Link>
              </p>
            </div>
