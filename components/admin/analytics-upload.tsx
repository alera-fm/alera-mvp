...
export default function AnalyticsUpload() {
  ...
  const handleUpload = async () => {
    if (!selectedFile || !platform || !reportingDate) {
      toast({
        variant: "destructive",
        title: "Missing information",
        description: "Please select a file, platform, and reporting date"
      })
      return
    }
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <Button 
            ...
            disabled={!selectedFile || !platform || !reportingDate || uploading}
            className="w-full"
          >
