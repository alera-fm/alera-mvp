...
import { Music, AirplayIcon as Spotify, Youtube } from "lucide-react"
          ...
          <div className="flex flex-wrap gap-1.5">
            {streaming_links.spotify && (
              <motion.a
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-full bg-[#1DB954] text-black text-xs font-medium shadow-lg"
              >
