    ...
    >
      ...
      >
        <div className="relative aspect-square w-full overflow-hidden">
          ...
          >
            <motion.div
              className="px-4 py-2 rounded-full flex items-center gap-1.5 text-sm font-medium shadow-lg bg-alera-yellow text-alera-purple-dark"
        ...
        <div className="p-3">
          ...
          <p className="text-base mt-1 font-bold text-alera-yellow">{item.price}</p>
        </div>
      </a>
    </motion.div>
  )
