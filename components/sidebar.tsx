...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "ALERA Agent", href: "/dashboard/agent", icon: MessageSquareText },
    ...(user?.isAdmin
  ...
  return (
    <div className="hidden overflow-y-auto md:flex md:w-72 md:flex-col fixed top-0 left-0 h-screen">
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive &&
                    !["/dashboard", "/dashboard/agent"].includes(item.href) && (
      ...
      {/* Bottom section */}
      <div className="mt-auto pt-5 pb-4 bg-gray-50 bg-white dark:bg-[#0a0a13] border border-gray-200 dark:border-gray-800/40 ">
