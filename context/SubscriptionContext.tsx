...
export interface Subscription {
  ...
  freeReleaseUsed?: boolean;
  freeReleaseId?: string;
}
...
export function SubscriptionProvider({ children }: { children: ReactNode }) {
  ...
  const [upgradeDialogTier, setUpgradeDialogTier] = useState<"plus" | "pro">(
    "plus"
  );
  ...
  const canAccessFeature = useCallback(
    async (feature: string, data?: any): Promise<boolean> => {
  ...
  const showUpgradeDialog = useCallback(
    (reason: string, requiredTier: "plus" | "pro") => {
