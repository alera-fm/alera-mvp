        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg p-4 max-w-md mx-auto shadow-lg">
            <div className="flex items-center justify-center gap-2">
              ...
              <div>
                <div className="font-bold text-lg">Save 20% on Yearly Plans!</div>
                <div className="text-sm opacity-90">Get 2 months free when you pay annually</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-orange-200 dark:border-orange-800 p-6">
            <div className="text-center mb-6">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">ALERA Label</h3>
              </div>
              <div className="text-4xl font-bold text-orange-600 mb-2">Custom</div>
              <p className="text-gray-600 dark:text-gray-400">Enterprise Solution</p>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden max-w-4xl mx-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Releases to 150+ Platforms</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Keep 100% of Royalties</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Spotify Verified Checkmark</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Custom Landing Page Builder</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Fan Monetization</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Multiple Artists</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Whitelabel Dashboard</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">Dedicated Support</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-500">✗</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
                  <td className="px-6 py-4 text-center text-sm text-green-600">✓</td>
